  ...
  template: `
    <div class="auth-page">
      <mat-card class="auth-card">
        ...
        <mat-card-content>
          <p class="hint">
            Enter your login ID. If an account exists, you will receive instructions to reset your password.
          </p>
...
export class ForgotPasswordPageComponent {
  ...
  submit(): void {
    ...
    this.auth
      .forgotPassword({
        loginIdentifier: this.form.controls.loginIdentifier.value,
      ...
      .subscribe({
        next: (res) => {
          ...
          if (res.success) {
            ...
            this.notify.success(
              res.message ?? 'If the account exists, a password reset link has been sent.'
            );
            if (this.resetLink) {
              return;
            }
