...
import { MemberSelfServiceDashboard, MemberTodayVisit } from '../../../shared/models/member-self-service.models';
...
export class MemberDashboardComponent implements OnInit {
  ...
  todayVisitCheckoutLabel(visit: MemberTodayVisit): string | null {
    if (visit.isCurrentlyCheckedIn) return null;
    if (visit.checkoutType === 'Auto' || visit.isAutoCheckout) return 'Auto Checked Out';
    if (visit.checkoutType === 'Manual') return 'Checked Out by Admin';
    return null;
  }
}
